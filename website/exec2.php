    ...
    <div class="container" id="main">
        <div class="form-block">
            ...
            <div class="form-body">
                ...
                $MDP=$_POST['MDP'];
                $user=$_POST['user'];
                $variable_ansible="IP=".escapeshellarg($IP)." user=".escapeshellarg($user)." MDP=".escapeshellarg($MDP)." servername=".escapeshellarg($IP)." ;
                liveExecuteCommand("sudo /usr/bin/ansible-playbook /etc/ansible/upgrade.yml -v --extra-vars '$variable_ansible'");
                ?></pre>
            <div class="form-block">
        </div>
